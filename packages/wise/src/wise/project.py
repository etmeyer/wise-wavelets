...
class DataConfiguration(nputils.BaseConfiguration):
    ...
    def __init__(self):
        ...
        ["mask_filename", "mask.fits", "Mask filename", None, validator_is(str), str, str, 0],
        ["bg_fct", None, "Background extraction fct", None, is_callable, None, None, 2],
        ["bg_coords", None, "Background region in coordinates [Xa,Ya,Xb,Yb]", "mas (= data.projection_unit)",
            validator_list(4, (int, float)), str2floatlist, jp.encode, 0],
        ["bg_use_ksigma_method", False, "Use ksigma method to estimate the background level", None, validator_is(bool), str2bool, str, 0],
        ["roi_coords", None, "Region of interest in coordinates [Xa,Ya,Xb,Yb]", "mas (= data.projection_unit)",
            validator_list(4, (int, float)), str2floatlist, jp.encode, 0],
        ["core_offset_filename", "core.dat", "Core offset filename", None, validator_is(str), str, str, 0],
        ["core_offset_fct", None, "Core offset generation fct", None, is_callable, None, None, 2],
        ["pre_bg_process_fct", None, "Initial processing before bg extraction", None, is_callable, None, None, 2],
        ["pre_process_fct", None, "Pre detection processing", None, is_callable, None, None, 2],
