...
class FinderConfiguration(nputils.BaseConfiguration):
    ...
    def __init__(self):
        # Local import avoids a circular import: project imports wds at module
        # load, so wds cannot import project at top level.
        ...
        data = [
            ...
            ["scales_snr_filter", None, "Per scales detection threshold", None, validator_is(dict), decode_scale_dict, jp.encode, 1],
            ...
            ["use_iwd", False, "Use Intermediate Wavelet Decomposition", None, validator_is(bool), str2bool, str, 0],
            ["dec", wtutils.uiwt, "Multiscale decompostion class", None, is_callable,
                lambda s: jp.decode(str2jsonfunction(s)), jp.encode, 1],
            ["wd_wavelet", 'b1', "Wavelet to use for the Wavelet Decomposition", None, validator_is(str), str, str, 1],
            ["iwd_wavelet", 'b3', "Wavelet to use for the Intermediate Wavelet Decomposition",
                None, validator_is(str), str, str, 1],
            ["dog_step", True, "DOG", None, validator_is(int), None, None, 2],
            ["dog_angle", True, "DOG", None, validator_is((int, float)), None, None, 2],
            ["dog_ellipticity", True, "DOG", None, validator_is((int, float)), None, None, 2],
            ["exclude_border_dist", 1, "Number of pixel from border to exclude", None, validator_is(int), int, str, 0],
